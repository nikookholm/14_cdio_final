...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "cdio_final" because\n';
  ...
  $wnd.__gwt_activeModules['cdio_final'] = {
    'moduleName' : 'cdio_final',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/cdio_final.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['cdio_final'].superdevmode = true;

  var expectedSuffix = '/cdio_final.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + cdio_final + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:cdio_final';
  var devModeSessionKey = '__gwtDevModeSession:cdio_final';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/cdio_final/cdio_final.nocache.js';
  ...
  $wnd.__gwt_activeModules['cdio_final'].canRedirect = true;
  $wnd.__gwt_activeModules['cdio_final'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/cdio_final?user.agent=' + ua + '&_callback=' + callback;
